...
| [`docs/accuracy/`](docs/accuracy/) | **Accuracy proof** — measured source of truth is [`docs/accuracy/baseline.json`](docs/accuracy/baseline.json) (latest snapshot: 100.00% on 11,422 modern-era S&P 500 FY filings, the honest ≥2010 figure; 100.00% overall on 19,616), citable to FactSet PIT / FASB ASC / Penman, reproducible via `duckdb -c ".read scripts/accuracy/accuracy_check.sql"` |
