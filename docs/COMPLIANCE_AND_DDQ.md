...
- **Source:** 100% of the data originates from the U.S. Securities and Exchange Commission (SEC) EDGAR system. Coverage runs from 1994 to present across approximately 18,000 active and delisted US-listed entities. The fundamentals dataset is exposed on every paid tier; the smart-money dataset (insider transactions and institutional ownership disclosures) is exposed on the Institutional tier only.
